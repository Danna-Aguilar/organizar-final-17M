...
class Modelo:
    # @property solo se puede usar dentro de las clases y dice que:
    # La siguiente linea es una propiedad.
    # _ antes de una variable indica que es privada.
    @property
    def posicion_x(self):
    ...
    def colisionando(self, modelo):
        # assert: le pasas una condición y si no se cumple se cierra el programa.
